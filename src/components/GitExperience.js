...
const data = [
  ...
  {
    head: "fix: resolve issue with payment gateway",
    date: "22 Jul 24",
    time: "03:20PM",
  },
  {
    head: "docs: update README with setup instructions",
    date: "21 Jul 24",
    time: "01:10PM",
  },
  {
    head: "chore: clean up deprecated methods",
    date: "20 Jul 24",
    time: "02:45PM",
  },
  {
    head: "feat: implement search functionality",
    date: "19 Jul 24",
    time: "11:00AM",
  },
  {
    head: "fix: correct typo in error message",
    date: "18 Jul 24",
    time: "04:30PM",
  },
  ...
  {
    head: "docs: refine API documentation",
    date: "15 Jul 24",
    time: "12:00PM",
  },
];
    ...
    <div>
            ...
            <ul className="canvas-list">
              {data.map((item, index) => (
                <li key={index} className="canvas-item">
                  ...
                  <p style={{ fontSize: "14px", color: "#3f4148" }}>
                    {item.date} {item.time}
                  </p>
                </li>
              ))}
      ...
      <section className="reviewandSecurity">
        <div className="review">
          ...
          <b>Code reviews.</b> Seamlessly integrates into your development
          workflow.
        </div>
